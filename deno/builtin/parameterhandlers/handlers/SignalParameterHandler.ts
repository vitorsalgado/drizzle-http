...
export class SignalParameterHandler implements ParameterHandler {
  ...
  handle(requestValues: RequestParameterization, value: unknown) {
    if (value === null || typeof value === "undefined") {
      throw new TypeError(
        `Signal parameter must not be null or undefined. (Index: ${this.parameter.index})`,
      );
    }
...
export class SignalParameterHandlerFactory
  implements ParameterHandlerFactory<SignalParameter, unknown> {
  static INSTANCE = new SignalParameterHandlerFactory();
