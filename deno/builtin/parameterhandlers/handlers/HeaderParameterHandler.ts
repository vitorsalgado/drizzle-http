...
export class HeaderParameterHandler
...
export class HeaderParameterHandlerFactory
  implements ParameterHandlerFactory<HeaderParameter, string | string[]> {
  static INSTANCE = new HeaderParameterHandlerFactory();
