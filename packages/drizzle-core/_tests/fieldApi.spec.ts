...
describe('Given an API with decorated class fields', function () {
  let drizzle: Drizzle
  let api: FieldApi
  ...
  describe('when request and response are plain text', function () {
    it('should return empty string for no-content response', function () {
  ...
  describe('when request fails with http error', function () {
    describe('and field is decorated with @ParseErrorBody()', function () {
